...
export class ImageGalleryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.galleryImages = [
      {
        small: 'assets/images/armenia.jpg',
        medium: 'assets/images/armenia.jpg',
        big: 'assets/images/armenia.jpg'
      },
      {
      ...
      {
        small: 'assets/images/gallery3.png',
        medium: 'assets/images/gallery3.png',
        big: 'assets/images/gallery3.png'
      },
      {
